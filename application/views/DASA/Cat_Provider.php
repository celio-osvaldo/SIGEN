...
<div class="card bg-card">
  <div class="table-responsive">
    <table class="table table-striped table-bordered table-condensed table-hover" id="table_provider" >
      ...
      <tbody>
        ...
        foreach ($catalogo_proveedor->result() as $row) {
         ?>
         <tr>
          <td><a class="navbar-brand" href="#" onclick="EditProvider(this.id)" role="button" id="<?php echo $row->id_catalogo_proveedor; ?>"><img src="..\Resources\Icons\edit.ico"></a></td>
