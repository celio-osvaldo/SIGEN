  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="NewCustomer" data-dismiss="modal">Agregar</button>
      </div>
    </div>
  </div>
</div>
  ...
  $(document).ready( function () {
    ...
    $('#UpdateCustomer').click(function(){
      ...
      if (nom_fiscal!="") {//Verificamos que los campos no estén vacíos
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Iluminacion/UpdateCustomer",
    ...
    $('#NewCustomer').click(function(){
      ...
      if (nom_fiscal!="") {//Verificamos que los campos no estén vacíos
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Iluminacion/NewCustomer",
