...
<script type="text/javascript">
    ...
    $('#Solicita_borrado_carpeta').click(function(){
      ...
      if(txt_justifica!=""){
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Iluminacion/Solicita_Borra_carpeta",
    ...
    $('#Solicita_borrado_archivo').click(function(){
      ...
      if(txt_justifica!=""){
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Iluminacion/Solicita_Borra_archivo",
    ...
    $('#Solicita_descarga_archivo').click(function(){
      ...
      if(pass_descarga!=""){
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Iluminacion/Solicita_descarga_archivo",
	...
	function descargar($ruta){
		ruta="Resources/Nube_Sigen/ILUMINACION/"+$ruta;
		base_url="<?php echo base_url() ?>";
