...
<div class="card bg-card">
  <div class="table-responsive">
    <table id="table_provider" class="table table-striped table-hover display" style="font-size: 9pt;">
        ...
        foreach ($catalogo_proveedor->result() as $row) {
         ...
         <tr>
          <td><a class="navbar-brand" href="#" onclick="EditProvider(this.id)" role="button" id="<?php echo $row->id_catalogo_proveedor; ?>">
            <button class="btn btn-outline-secondary"><img width="25" src="..\Resources\Icons\353430-checkbox-edit-pen-pencil_107516.ico" alt="Editar" style="filter: invert(100%)" />
            </button>
          </a></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <label class="label-control">Giro*</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <label class="label-control">Email 2</label>
            <input type="email" id="edit_email2" class="form-control input-sm" required="true">
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
  ...
  $(document).ready( function () {
    ...
    $('#UpdateProvider').click(function(){
      ...
      if (nom_fiscal!="") {//Verificamos que los campos no estén vacíos
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Quinta/UpdateProvider",
