<div class="row" >
  <div class="col-md-9" align="center">
    <h5>Historial de Precio de Mobiliario</h5>
  </div>
  <div class="col-md-3" align="center">
    <button type="button" onclick="Regresar()" class="btn btn-success" >Regresar a Almacen de Mobiliario</button>
  </div>
</div>
...
<div class="row" align="center">
  <div class="col-md-12">
    <span class="badge badge-info col-md-2">
      Nombre Mobiliario:<hr><?php echo $Product_Inv_info->prod_alm_nom; ?>
    </span>
    <span class="badge badge-info col-md-2">
