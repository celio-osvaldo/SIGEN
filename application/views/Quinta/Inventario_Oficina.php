...
<div class="row">
  <div class="col-9">
    <h3 align="center">Almacén de Consumibles</h3>
  </div>
  <div class="col-3">
...
<div class="card bg-card">
  <div class="table-responsive">
    <table id="table_Inv_Office" class="table table-striped table-hover display" style="font-size: 9pt;">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <input type="text" onblur="SeparaMiles(this.id)" id="new_prec" class="form-control input-sm">
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
      ...
      <div class="modal-body">
        ...
        <div class="row">
         ...
         <div class="col-md-4">
          ...
          <input type="text" onblur="SeparaMiles(this.id)" id="edit_prec" class="form-control input-sm">
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
  ...
  $(document).ready( function () {
    ...
    $('#InvProduct').click(function(){
      ...
      if (nueva_exist>=0) {
        if (inv_cant_prod!=""&&inv_cant_prod!=0&&inv_cant_prod>0) {//Verificamos que los campos no estén vacíos
          $.ajax({
            type:"POST",
            url:"<?php echo base_url();?>Quinta/Update_Inv_Consu",
    ...
    $('#UpdateConsumible').click(function(){
      ...
      if (nom_prod!=""&&unid_med!=null&&proveedor!=null) {//Verificamos que los campos no estén vacíos
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Quinta/UpdateConsumible",
    ...
    $('#NewConsumible').click(function(){
      ...
      if (nom_prod!=""&&unid_med!=null&&proveedor!=null) {//Verificamos que los campos no estén vacíos
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Quinta/NewAlm_Consumible",
