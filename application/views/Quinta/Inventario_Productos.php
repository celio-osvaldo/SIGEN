...
<div class="row">
  <div class="col-9">
    <h3 align="center">Almacén de Mobiliario</h3>
  </div>
    <div class="col-3">
    <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#NewInv_ProdModal"><img src="<?php echo base_url() ?>Resources/Icons/add_icon.ico">Nuevo Mobiliario</button>
  </div>
</div>
    ...
    <table id="table_nomina" class="table table-striped table-hover display" style="font-size: 9pt;">
      <thead class="bg-primary" style="color: #FFFFFF;" align="center">
        <tr>
          ...
          <th>Existencia</th>
          <th>Cógido Mobiliario</th>
          <th>Descripción del Mobiliario</th>
          <th>Comentario</th>
          <th>Historial</th>
        </tr>
      </thead>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <label class="label-control">Nombre Mobiliario</label>
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <select class="form-control" name="new_unid_med" id="new_unid_med">
              <option disabled selected>Seleccione Unidad Medida</option>
          ...
          <div class="col-md-5">
            <label class="label-control">Modelo</label><br>   
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <label>Cógido de Mobiliario</label>
            <input type="text" id="new_cod" maxlength="45" class="form-control">
          </div>
        </div>     
        <label>Descripción del Mobiliario</label>
...
<div class="modal fade" id="EditProductModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modificar Mobiliario</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <label class="label-control">Precio Unitario</label>
            <input type="text" id="edit_prec" onblur="SeparaMiles(this.id)" class="form-control input-sm">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <label class="label-control">Cógido de Mobiliario</label>
            <input type="text" id="edit_cod" class="form-control input-sm">
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <label class="label-control">Descripción del Mobiliario</label>
      ...
      <div class="modal-body" style="background-color: #6BF57A">
        ...
        <div class="row"style="background-color: #C1C1C1">
          ...
          <div class="col-md-4">
            ...
            <input disabled="true" type="text" id="inv_prec" onblur="SeparaMiles(this.id)" class="form-control input-sm">
          </div>
        </div>
        <div class="row" >
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            <label class="label-control">Mobiliario a Agregar/Restar</label>
          ...
          <div class="col-md-3">
            ...
            <input type="text" id="inv_prec_new" onblur="SeparaMiles(this.id)" class="form-control input-sm">
          </div>
        </div>
        <div class="row" >
          <div class="col-md-5">
          ...
          <div class="col-md-7">
            <label>Referencia (Factura, Observación, etc.)</label>
  ...
  $(document).ready( function () {
    ...
    $('#UpdateProduct').click(function(){
      ...
      if (nom_prod!=""&&unid_med!=null) {//Verificamos que los campos no estén vacíos
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Quinta/Update_Alm_Product",
    ...
    $('#InvProduct').click(function(){
      ...
      if (nueva_exist>=0) {
        if (inv_cant_prod!=""&&inv_cant_prod!=0&&inv_cant_prod>0) {//Verificamos que los campos no estén vacíos
          $.ajax({
            type:"POST",
            url:"<?php echo base_url();?>Quinta/Update_Inv_Prod",
            data:{id_prod:id_prod, inv_tipo_mov:inv_tipo_mov, inv_cant_prod:inv_cant_prod, precio_unit_old:precio_unit_old, inv_prec_new:inv_prec_new, inv_procedencia:inv_procedencia, inv_referencia:inv_referencia, existencia_old:existencia_old},
            success:function(result){
              //alert(result);
              if(result){
    ...
    $('#NewProduct').click(function(){
      ...
      if (nom_prod!=""&&unid_med!=null) {//Verificamos que los campos no estén vacíos
        $.ajax({
          type:"POST",
          url:"<?php echo base_url();?>Quinta/NewAlm_Product",
