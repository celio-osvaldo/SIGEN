                        ...
                        foreach ($inventories->result() as $row) {?>
                            <tr>
                              <!--  <td id=""><?php echo "".$row->id_catalogo_producto.""; ?></td>   -->
                                ...
                                <td id="<?php echo "provider".$row->id_catalogo_producto.""; ?>"><?php echo "".$row->catalogo_proveedor_nom_fiscal.""; ?></td>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
         ...
         <form class="form-group" id="editproduct" method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>Quinta/UpdateInfoProduct">
              <div class="modal-body">
                    <div class="row">
...
$('#saveProduct').click(function(){
  ...
  datos.append('dateInsert',dateInsert);
   ...
   if(nameProductInsert!=""&&priceInsert!=""){
    $.ajax({
      url: '<?php echo base_url();?>Quinta/AddProduct',
      type: 'post',
      data: datos,
      contentType: false,
      processData: false,
...
$(document).ready(function(e){
    $("#editproduct").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>Quinta/UpdateInfoProduct',
