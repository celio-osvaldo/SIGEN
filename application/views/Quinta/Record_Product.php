...
<div class="row">
  <div class="col">
    ...
    <div class="col" align="center">
      ...
      <span class="badge badge-info">
        <h6 align="center">
          Proveedor Actual:<hr><?php echo $product_info->catalogo_proveedor_nom_fiscal; ?>
        </h6>
      </span>
      <span class="badge badge-info">
        <h6 align="center">
          Precio Actual:<hr>$<?php echo number_format($product_info->catalogo_producto_precio,2,'.',','); ?>
        </h6>
      </span>
      <span class="badge badge-info">
        <h6 align="center">
                    ...
                    <tbody>
                        ...
                        foreach ($record_product->result() as $row) {?>
                            <tr>
                                ...
                                <td id="<?php echo "proveedor".$row->id_historial_precio_producto.""; ?>"><?php echo "".$row->catalogo_proveedor_nom_fiscal."";?>                                    
                                </td>
