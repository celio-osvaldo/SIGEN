            ...
            <div class="modal-body">
                ...
                <div class="row">                
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" onblur="Separa_Miles(this.id)" class="form-control" name="add_iva" id="add_iva" required="true" value="0.00">
                    </div>
                     <div class="col-md-3">
                        <label class="label-control">Ret IVA</label>
                        <input type="text" onblur="Separa_Miles(this.id)" class="form-control" name="add_ret_iva" id="add_ret_iva" required="true" value="0.00">
                    </div>
                    <div class="col-md-3">
                        <label class="label-control">Ret ISR</label>
                        <input type="text" onblur="Separa_Miles(this.id)" class="form-control" name="add_ret_isr" id="add_ret_isr" required="true" value="0.00">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <label class="label-control">IEPS</label>
                        <input type="text" onblur="Separa_Miles(this.id)" class="form-control" name="add_ieps" id="add_ieps" required="true" value="0.00">
                    </div>
                    <div class="col-md-3">
                        <label class="label-control">DAP</label>
                        <input type="text" onblur="Separa_Miles(this.id)" class="form-control" name="add_dap" id="add_dap" required="true" value="0.00">
                    </div>
                    <div class="col-md-6">
...
$(document).ready(function(e){
    $("#addReport").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>Salinas/AddViaticExpend',
    ...
    $("#edit_addReport").on('submit', function(e){ //Edit Viatic Report
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>Salinas/UpdateViaticExpend',
            data: new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
