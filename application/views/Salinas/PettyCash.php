                ...
                <tr>
                    ...
                    <tbody>
                        ...
                        foreach ($cash->result() as $row) {?>
                            ...
                            <td align="center" id="<?php echo "bill_url".$row->id_lista_caja_chica.""; ?>"><a role="button" class="btn btn-outline-dark openfile" id="<?php echo "".$row->lista_caja_chica_url_factura.""; ?>" onclick="Display_bill(this.id)"><img height="20" src="<?php echo base_url() ?>Resources/Icons/invoice_icon_128337.ico" style="filter: invert(100%)"></a></td>
                            ...
                            <td><a role="button" class="btn btn-outline-dark" onclick="Edit_Registro(this.id)" id="<?php echo "".$row->id_lista_caja_chica.""; ?>"><img height="20" src="..\Resources\Icons\353430-checkbox-edit-pen-pencil_107516.ico" alt="Editar" style="filter: invert(100%)" /></a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input value="0.00" class="form-control" type="text" name="add_iva" id="add_iva" onblur="SeparaMiles(this.id)">
                            </div>
                            <div class="col-md-3">
                                <label class="label-control">Ret IVA</label>
                                <input value="0.00" class="form-control" type="text" name="add_ret_iva" id="add_ret_iva" onblur="SeparaMiles(this.id)">
                            </div>
                            <div class="col-md-3">
                                <label class="label-control">Ret ISR</label>
                                <input value="0.00" class="form-control" type="text" name="add_ret_isr" id="add_ret_isr" onblur="SeparaMiles(this.id)">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <label class="label-control">IEPS</label>
                                <input value="0.00" class="form-control" type="text" name="add_ieps" id="add_ieps" onblur="SeparaMiles(this.id)">
                            </div>
                            <div class="col-md-3">
                                <label class="label-control">DAP</label>
                                <input value="0.00" class="form-control" type="text" name="add_dap" id="add_dap" onblur="SeparaMiles(this.id)">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <label class="label-control">Monto</label>
                                <div id="tm1" style="display:;">
                                    <input class="form-control" onblur="SeparaMiles(this.id)" type="text" name="edit_money" id="edit_money">
                                </div>
                                <div id="tm2" style="display:none;">
                            ...
                            <div class="col-md-3">
                                <label class="label-control">IVA</label>
                                <input value="0.00" class="form-control" type="text" name="edit_iva" id="edit_iva" onblur="SeparaMiles(this.id)">
                            </div>
                            <div class="col-md-3">
                                <label class="label-control">Ret IVA</label>
                                <input value="0.00" class="form-control" type="text" name="edit_ret_iva" id="edit_ret_iva" onblur="SeparaMiles(this.id)">
                            </div>
                            <div class="col-md-3">
                                <label class="label-control">Ret ISR</label>
                                <input value="0.00" class="form-control" type="text" name="edit_ret_isr" id="edit_ret_isr" onblur="SeparaMiles(this.id)">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <label class="label-control">IEPS</label>
                                <input value="0.00" class="form-control" type="text" name="edit_ieps" id="edit_ieps" onblur="SeparaMiles(this.id)">
                            </div>
                            <div class="col-md-3">
                                <label class="label-control">DAP</label>
                                <input value="0.00" class="form-control" type="text" name="edit_dap" id="edit_dap" onblur="SeparaMiles(this.id)">
                            </div>
                            <div class="col-md-6">
                                <label class = "control-label">Concepto</label>
...
$(document).ready(function(e){
    $("#addReport").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>Salinas/AddReportPettyCash',
    ...
    $("#editReport").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>Salinas/UpdateReportPettyCash',
            data: new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
