    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
         ...
         <form class="form-group" id="editproduct" method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>Salinas/UpdateInfoProduct">
              <div class="modal-body">
                    <div class="row">
...
$(document).ready(function(e){
    $("#addproduct").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>Salinas/AddProduct',
...
$(document).ready(function(e){
    $("#editproduct").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>Salinas/UpdateInfoProduct',
            data: new FormData(this),
            contentType: false,
            cache: false,
            processData:false,
...
<script>
  function Display_product($id){
    ...
    var name_product=$("#name"+$id).text();
    var id=$id;
    var url = "<?php echo base_url()?>Resources/Products&Services/Salinas/"+id+".jpg";
