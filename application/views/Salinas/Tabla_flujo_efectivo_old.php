<div style="text-align: right;">
  ...
  <input type="text" onblur="SeparaMiles(this.id)" id="saldo_mes_anterior" value="<?php echo $sal_ban_ant; ?>">
</div> 
 ...
 <tbody>
  ...
  <?php  $no=1; $saldo_total=$sal_ban_ant; foreach ($ingresos_venta_mov->result() as $row) {
    ...
    <tr>
     ...
     <td></td>
     <td id="<?php echo "abono".$row->id_venta_mov;?>">$<?php echo number_format($row->venta_mov_monto,2,'.',',').""; ?>
 ...
 $no++;
  ...
  <?php  $no=1; foreach ($egresos_caja_chica->result() as $row) {
    ...
    <tr>
     ...
     <td id="<?php echo "cargo".$row->id_lista_caja_chica;?>">$<?php echo number_format($row->lista_caja_chica_gasto,2,'.',',').""; ?>
     <td></td>
 ...
 $no++;
  ...
  <?php  $no=1; foreach ($egresos_gasto_venta->result() as $row) {
    ...
    <tr>
     ...
     <td id="<?php echo "cargo".$row->id_gasto_venta;?>">$<?php echo number_format($row->gasto_venta_monto,2,'.',',').""; ?>
     <td></td>
 ...
 $no++;
  ...
  <?php  $no=1; foreach ($egresos_viatico->result() as $row) {
    ...
    <tr>
     ...
     <td id="<?php echo "cargo".$row->id_lista_viatico;?>">$<?php echo number_format($row->lista_viatico_importe,2,'.',',').""; ?>
     <td></td>
 ...
 $no++;
  ...
  <?php  $no=1; foreach ($egresos_otros_gastos->result() as $row) {
    ...
    <tr>
     ...
     <td id="<?php echo "cargo".$row->id_OGasto;?>">$<?php echo number_format($row->saldo,2,'.',',').""; ?>
     <td></td>
